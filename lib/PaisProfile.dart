        ...
        children: [
          ...
          Row(
            children: [
              ...
              TextButton(onPressed: () => addCountry(paisesVisitados),
                  child: Text("Visited")),
            ],
          ),
          Row(
            children: [
              Icon(Icons.article),
              TextButton(onPressed: () => addCountry(paisesNoVisitados),
                  child: Text("Not visiting")),
            ],
          ),
          Row(
            children: [
              Icon(Icons.article),
              TextButton(onPressed: () => addCountry(paisesPlan),
                  child: Text("Plan to visit")),
            ],
          ),
        ],
      ),
